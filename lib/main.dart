...
class _chatappState extends State<chatapp> {
  ...
  Widget _BScard(int value) {
    ...
    if (value == 1) {
      url =
          "https://www.itca.edu.sv/wp-content/uploads/2016/11/zacatecoluca.png";
    } else if (value == 2) {
      url =
          "https://www.itca.edu.sv/wp-content/uploads/2020/05/ITCA-REGIONAL-SANTA-ANA-INAUGURo-MODERNA-ACADEMIA-CISCO-5.jpeg";
    } else if (value == 3) {
    ...
    return Scaffold(
        ...
        child: new ListView(
          children: [
            ...
            new ListTile(
              ...
              onTap: () {
                const link =
                    "https://drive.google.com/file/d/1ol9DUDmdyMi9LcLVevKwgXHPOKltv6Bu/view?usp=drive_link";
            ...
            new ListTile(
              ...
              onTap: () {
                ...
                launchUrl(Uri(scheme: 'tel', path: "76289457"),
                    mode: LaunchMode.externalApplication);
              },
            ),
            Divider(),
      ...
      body: ListView(
        ...
        children: [
          ...
          _BScard(1),
          _BSDetails("REGIONAL DE ZACATECOLUCA",
              "TÉCNICO EN INGENIERÍA EN DESARROLLO DE SOFTWARE", 1),
          //POSIBLES OCUPACIONES DE TRABAJO:
          _BScard(2),
          _BSDetails("POSIBLES OCUPACIONES DE TRABAJO:",
              "Desarrollador de Sistemas de Información.", 2),
          ...
          _BSDetails(
              ...
              "Utilizar lenguajes de programación estructurada y orientada a objetos.",
              4),
        ],
      ),
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          const link = "https://rocko-bot.vercel.app/";
        ...
        label: Row(
          children: [
            ...
            SizedBox(
                width:
                    8), // Espacio entre la imagen y el texto (ajústalo según lo necesites)
            Text("Rocko Bot"),
          ],
        ),
